...
Page({
  ...
  onLoad: function (options) {
    ...
    if (scene == undefined || scene == 'undefined') { } else {
      this.setData({
        sellId: scene
      })
      setTimeout(function () {
  ...
  onReady: function () {
    ...
    // 相关推荐  
    util.myWxRequest(app.globalData.getGoodsType, { page: that.data.page, pageSize: that.data.pageSize }, function (res) {
  ...
  scrollToLower: function () {
    ...
    pageSize += 10;
    // 相关推荐  
    util.myWxRequest(app.globalData.getGoodsType, { page: that.data.page, pageSize: pageSize }, function (res) {
      let arrays = res.data.data.PageInfo.list;
      console.log(res)
      that.setData({
        recommend: arrays
